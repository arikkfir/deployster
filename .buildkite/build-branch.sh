...
docker build --tag quay.io/kfirs/deployster-dresource:${BUILDKITE_COMMIT} -f ./resources/Dockerfile.dresource ./resources
docker build --tag quay.io/kfirs/deployster-gcp:${BUILDKITE_COMMIT} -f ./resources/Dockerfile.gcp ./resources
docker build --tag quay.io/kfirs/deployster-gcp-cloud-sql:${BUILDKITE_COMMIT} -f ./resources/Dockerfile.gcp_cloud_sql ./resources
docker build --tag quay.io/kfirs/deployster-gcp-compute-ip-address:${BUILDKITE_COMMIT} -f ./resources/Dockerfile.gcp_compute_ip_address ./resources
docker build --tag quay.io/kfirs/deployster-gcp-gke-cluster:${BUILDKITE_COMMIT} -f ./resources/Dockerfile.gcp_gke_cluster ./resources
docker build --tag quay.io/kfirs/deployster-gcp-iam-policy:${BUILDKITE_COMMIT} -f ./resources/Dockerfile.gcp_iam_service_account ./resources
docker build --tag quay.io/kfirs/deployster-gcp-iam-service-account:${BUILDKITE_COMMIT} -f ./resources/Dockerfile.gcp_iam_policy ./resources
docker build --tag quay.io/kfirs/deployster-gcp-project:${BUILDKITE_COMMIT} -f ./resources/Dockerfile.gcp_project ./resources
docker build --tag quay.io/kfirs/deployster-k8s:${BUILDKITE_COMMIT} -f ./resources/Dockerfile.k8s ./resources
docker build --build-arg "VERSION=${BUILDKITE_COMMIT}" --tag quay.io/kfirs/deployster:${BUILDKITE_COMMIT} -f ./Dockerfile .
