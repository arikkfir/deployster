...
def main():
    ...
    k8s_object_types: Mapping[str, dict] = {
        'kfirz/deployster-k8s-clusterrole': {
            'kind': 'ClusterRole',
            'api_version': 'rbac.authorization.k8s.io/v1',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-clusterrolebinding': {
            'kind': 'ClusterRoleBinding',
            'api_version': 'rbac.authorization.k8s.io/v1',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-configmap': {
            'kind': 'ConfigMap',
            'api_version': 'v1',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-cronjob': {
            'kind': 'CronJob',
            'api_version': 'batch/v1beta1',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-daemonset': {
            'kind': 'DaemonSet',
            'api_version': 'apps/v1beta2',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-deployment': {
            'kind': 'Deployment',
            'api_version': 'apps/v1beta2',
            'factory': K8sDeployment
        },
        'kfirz/deployster-k8s-horizontalpodautoscaler': {
            'kind': 'HorizontalPodAutoscaler',
            'api_version': 'autoscaling/v1',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-ingress': {
            'kind': 'Ingress',
            'api_version': 'extensions/v1beta1',
            'factory': K8sIngress
        },
        'kfirz/deployster-k8s-job': {
            'kind': 'Job',
            'api_version': 'batch/v1',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-namespace': {
            'kind': 'Namespace',
            'api_version': 'v1',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-networkpolicy': {
            'kind': 'NetworkPolicy',
            'api_version': 'networking/v1',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-node': {
            'kind': 'Node',
            'api_version': 'v1',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-persistentvolume': {
            'kind': 'PersistentVolume',
            'api_version': 'v1',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-persistentvolumeclaim': {
            'kind': 'PersistentVolumeClaim',
            'api_version': 'v1',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-pod': {
            'kind': 'Pod',
            'api_version': 'v1',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-replicaset': {
            'kind': 'ReplicaSet',
            'api_version': 'apps/v1beta2',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-replicationcontroller': {
            'kind': 'ReplicationController',
            'api_version': 'v1',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-role': {
            'kind': 'Role',
            'api_version': 'rbac.authorization.k8s.io/v1',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-rolebinding': {
            'kind': 'RoleBinding',
            'api_version': 'rbac.authorization.k8s.io/v1',
            'factory': K8sResource
        },
        'kfirz/deployster-k8s-secret': {
            'kind': 'Secret',
            'api_version': 'v1',
            'factory': K8sSecret
        },
        'kfirz/deployster-k8s-service': {
            'kind': 'Service',
            'api_version': 'v1',
            'factory': K8sService
        },
        'kfirz/deployster-k8s-serviceaccount': {
            'kind': 'ServiceAccount',
            'api_version': 'v1',
            'factory': K8sResource
        },
